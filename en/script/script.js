document.addEventListener('DOMContentLoaded', () => {
    ...
    function addSection(title, content, presenter) {
        ...
        sectionItem.innerHTML = `
            ...
            <button class="edit-btn" onclick="editSection(this)"><i class="fas fa-edit"></i> Edit</button>
            <button class="delete-btn" onclick="deleteSection(this)"><i class="fas fa-trash"></i> Delete</button>
