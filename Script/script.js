document.addEventListener('DOMContentLoaded', () => {
    ...
    function addSection(title, content, presenter) {
        ...
        sectionItem.innerHTML = `
            ...
            <button class="edit-btn" onclick="editSection(this)"><i class="fas fa-edit"></i> 編集</button>
            <button class="delete-btn" onclick="deleteSection(this)"><i class="fas fa-trash"></i> 削除</button>
